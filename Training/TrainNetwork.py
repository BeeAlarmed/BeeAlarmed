...
parser.add_argument("--gpu", action="store_true", help="Use --gpu=True to train network with GPU and nothing to train on CPU.")
...
train, val = tfds.load('bee_dataset/bee_dataset_150',
        batch_size= 11, #100, #changed batch to load to Jetson Nano
        as_supervised=True,
